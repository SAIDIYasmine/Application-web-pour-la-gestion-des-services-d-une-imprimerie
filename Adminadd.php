...
if(isset($_FILES['fileToUpload'] )&& isset($_POST['btnValider'])){
    ...
    $sql = "INSERT INTO cours VALUES (0,0,'$nom','$date_depot','$nbr_page','$universite', '$ecole','$filiere','$niveau', '$nbr_image',$nbr_page*0.25)";
    $bdd->exec($sql);
}    
?>
			...
			<section class="header_text sub">
				...
				<div class="formArticle">
            		...
            		<table>
                		...
                		<input type="reset" value="Annuler" onclick="location.href='admin.php'"/>
                		</p>
                		</td>
            			</tr>
            		</table>
